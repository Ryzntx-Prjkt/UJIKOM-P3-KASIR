            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 g-4">
                        ...
                        <div class="card elevation-5 shadow-card">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="" class="btn btn-primary" id="keranjang-modal"
                                    data-attr="{{route('entri-transaksi.show', $item->id)}}" data-bs-toggle="modal"
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        <button type="button" id="button_transaksi" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#pembayaranModal">Bayar Transaksi</button>
                    </div>
                    @endif
                </div>
            </div>
